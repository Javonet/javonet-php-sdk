...
echo "🔍 Checking Git LFS files for Javonet SDK...\n\n";

$javonetPackageDir = dirname(__DIR__);
if (!is_dir($javonetPackageDir)) {
    echo "❌ Javonet package directory not found: $javonetPackageDir\n";
    exit(1);
}
...
$packagesDir = $javonetPackageDir . '/packages';
    ...
    if (file_exists($lockFilePath)) {
        ...
        if (isset($lockData['packages'])) {
            foreach ($lockData['packages'] as $package) {
                if ($package['name'] === 'javonet/javonet-php-sdk') {
...
{
    $baseUrl = 'https://github.com/Javonet/javonet-php-sdk/raw';
